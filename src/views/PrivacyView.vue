<template>
  <div class="flex justify-center overflow-auto h-full p-4">
    <div class="prose">
      ...
      <p>We use Your Personal data to provide and improve the Service. By using the Service, You agree to the collection
        ...
        help
        of the <a href="https://www.termsfeed.com/privacy-policy-generator/" target="_blank">Privacy Policy
          Generator</a>.
      </p>
      ...
      <ul>
        ...
        <li>
          <p><strong>Application</strong> refers to Uconverter, the software program provided by the Company.</p>
        </li>
        <li>
          <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or
            &quot;Our&quot; in this Agreement) refers to Uconverter.</p>
        </li>
        <li>
        ...
        <li>
          <p><strong>Website</strong> refers to Uconverter, accessible from <a href="https://uconverter.mehmetuysal.dev"
              rel="external nofollow noopener" target="_blank">https://uconverter.mehmetuysal.dev</a></p>
        </li>
        <li>
      ...
      <ul>
        <li>By email: hi@mehmetuysal.dev</li>
      </ul>
    </div>
  </div>
</template>
